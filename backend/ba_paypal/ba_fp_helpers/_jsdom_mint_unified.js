#!/usr/bin/env node
/**
 * jsdom + sandbox_polyfill Integration mint runner:
 *  1) hsw(req) -> n (PoW)
 *  2) hsw(1, encode(body)) -> encrypt_req_data (ExtType-18)
 *  3) msgpack Pack [[cJSON, ext18]] output packed_b64
 * Complete replacement happy-dom two-stage，unified environment。
 */
'use strict';
const fs = require('fs');
