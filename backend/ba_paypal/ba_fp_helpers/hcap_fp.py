"""pure Python hCaptcha Fingerprint builder (zero-browser)。

refer to Implex-ltd/hcaptcha-reverse fp_build: hsw(jwt, fp_json_b64) Two-parameter signature,
Fingerprints are constructed from the outside as plain text JSON, base64 Later actions hsw The second parameter is passed in。
"""
import base64
import json
import random
