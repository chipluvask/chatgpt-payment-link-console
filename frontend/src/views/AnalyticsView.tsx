...
export function AnalyticsView() {
  ...
  const refresh = async () => {
    ...
    try {
      ...
      if (data && data.ok) {
        ...
        setErr((data && data.error) || "Loading failed");
      }
    } catch (e: any) {
      setErr((e && e.message) || "network error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const renderBarList = (
    ...
    if (data.length === 0) {
      return <div className="empty" style={{ padding: 24 }}>No data yet</div>;
    }
    return (
  ...
  return (
    <div className="page">
      <div className="page-head">
        <div>
          <h2 className="page-title">Statistical analysis</h2>
          <p className="page-sub">success rate、Country distribution、Failure Reasons and Segment Level Matrix</p>
        </div>
      ...
      <div className="grid grid-4" style={{ marginBottom: 16 }}>
        ...
        <div className="stat-card">
          <span className="stat-label">Delay P50 / P95</span>
      ...
      <div className="analytics-grid">
        <div className="card">
          <div className="card-head">
            <span className="card-title">Distribution of successful countries</span>
          </div>
        ...
        <div className="card">
          <div className="card-head">
            <span className="card-title">Distribution of failed states</span>
          </div>
        ...
        <div className="card">
          <div className="card-head">
            <span className="card-title">Reason for failure</span>
          </div>
        ...
        <div className="card">
          <div className="card-head">
            <span className="card-title">Segment level matrix</span>
          </div>
          {matrixCountries.length === 0 ? (
            <div className="empty" style={{ padding: 24 }}>No data yet</div>
          ) : (
