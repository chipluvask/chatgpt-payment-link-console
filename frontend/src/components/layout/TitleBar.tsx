...
export function TitleBar() {
  ...
  const wsMap: Record<string, { ind: string; label: string }> = {
    online: { ind: "ind-green", label: "online" },
    offline: { ind: "ind-grey", label: "Offline" },
    connecting: { ind: "ind-orange", label: "Connecting" },
    error: { ind: "ind-red", label: "mistake" },
  };
  ...
  return (
    <header className="titlebar">
      ...
      <div className="titlebar-title">
        ...
        <span className="titlebar-sub">Chain lifting engine v2</span>
      </div>
