# -*- coding: utf-8 -*-
"""from hsw.js Capture inline at runtime WASM (hook WebAssembly.compile/instantiate)。

usage: python extract_hsw_wasm.py <hsw_js_path> <out_wasm_path>
rely: node (hsw.js exist node vm Load in to trigger wasm initialization)
"""
import os
import subprocess
import sys
