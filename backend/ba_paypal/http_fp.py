...
Reverses GPT_PLUS_PPPure protocol version + desktop autofill/vxt findings into a runnable
...
def _happy_dom_node_path() -> str:
    ...
    candidates = [
        ...
        Path(r"C:\Users\Administrator\Desktop\GPT_PLUS_PPPure protocol version\webui\frontend\node_modules"),
